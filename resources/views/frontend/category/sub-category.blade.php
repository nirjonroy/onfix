...
@php
    ...
    $pageTitle = $currentCategory?->name ?? 'Services';
    $pageDescription = $currentCategory?->short_description ?: '';
    $serviceIcons = [
        'icon-phonendoscope',
                    ...
                    <section class="row-services">
                        <div class="container par-ser">
                            ...
                            <div class="row wrap-row-services">
                                            ...
                                            <div class="image-box-item clearfix">
                                                <div class="inner">
                                                    <div class="thumb data-effect-item">
                                                        <img src="{{ $subCategory->image ? asset($subCategory->image) : asset($fixmo . '/img/services/service-1.jpg') }}" alt="{{ $subCategory->name }}">
                                                    ...
                                                    <div class="text-wrap">
                                                        <div class="row m-0">
                                                            ...
                                                            <div class="col-md-9">
                                                                <div class="title">
                                                                    <h4 class="title-heading big"><a href="{{ route('front.services.subcategory', ['category' => $subCategory->category->slug, 'subcategory' => $subCategory->slug]) }}">{{ $subCategory->name }}</a></h4>
                                                                </div>
                                                                <div class="frame-button">
                                                                    <a href="{{ route('front.services.subcategory', ['category' => $subCategory->category->slug, 'subcategory' => $subCategory->slug]) }}" class="fixmo-button btn-font-1">
                                                                        Read More
                                ...
                                @empty
                                    <div class="col-md-12">
                                        <p class="title-small text-center">No subcategories available.</p>
                                    </div>
                                @endforelse
                            </div>
                        </div>
